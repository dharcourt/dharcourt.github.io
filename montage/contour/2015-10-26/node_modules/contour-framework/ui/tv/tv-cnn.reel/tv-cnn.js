 ...
 * @extends Component
 */
exports.TvCnn = Component.specialize(/** @lends TvCnn# */ {
    constructor: {
        value: function TvCnn() {
    ...
    _initWebCam: {
        value: function () {
            var camvars = {},
                params = {};
            var element =  document.getElementById('cnn_web_holder');
            if (element.children.length === 0) {
                camvars.domain = "https://relay.ozolio.com";
                camvars.camera_doc = 'CID_ATFO00000041';
                camvars.app_mode = "simple";
                camvars.chn_mode = "none";
                params.allowFullScreen = "true";
                params.allowScriptAccess = "always";
                self.webcam = new jwebcam(camvars, "cnn_web_holder", 420, 360, params);
            }
        }
    },
